/*
  ...
  gengetopt --input=cmdline --include-getopt 
...
const char *gengetopt_args_info_purpose = "Encrypt/decrypt mi_thermald configs";

const char *gengetopt_args_info_usage = "Usage: mi-thermal-crypt [OPTION]...";
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'o':	/* Output filename.  */
          ...
          break;
        case 'e':	/* Encrypt input plain text file to output file.  */
